...
#define APS_A_OUT_Pin GPIO_PIN_4
#define APS_A_OUT_GPIO_Port GPIOA
#define APS_B_OUT_Pin GPIO_PIN_5
#define APS_B_OUT_GPIO_Port GPIOA
#define APS_A_IN_Pin GPIO_PIN_6
#define APS_A_IN_GPIO_Port GPIOA
#define APS_B_IN_Pin GPIO_PIN_7
#define APS_B_IN_GPIO_Port GPIOA
#define APS_A_OUT_IN_Pin GPIO_PIN_4
#define APS_A_OUT_IN_GPIO_Port GPIOC
#define APS_B_OUT_IN_Pin GPIO_PIN_5
#define APS_B_OUT_IN_GPIO_Port GPIOC
...
#define DISP_1B_Pin GPIO_PIN_12
#define DISP_1B_GPIO_Port GPIOB
